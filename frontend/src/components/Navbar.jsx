...

                    {
                        access_token ?
                            ...
                            <>
                                ...
                                <Link className="bg-gray-200dark:bg-black text-gray-800 dark:text-white py-2 px-5 rounded-full hidden md:block hover:bg-gray-300 dark:hover:bg-[#27272a] transition " to="/signup">
                                    Sign Up
                                </Link>
                            </>
                    }
