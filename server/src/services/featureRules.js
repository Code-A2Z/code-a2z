export const FEATURE_RULES = [
  ...
  },
  {
    ...
    signals: { paths: [".github/workflows/", ".gitlab-ci.yml", ".circleci/"] }
  },
  {
  ...
  // ───────────── Docs / Platform ─────────────
  {
    capability: "Documentation & Developer Experience",
    signals: { files: ["README.md"], keywords: ["docs", "storybook"] }
  },

  // ───────────── Catch-all ─────────────
  {
    capability: "Automation / Tooling",
    signals: { keywords: ["script", "automation", "cli"] }
  }
];
